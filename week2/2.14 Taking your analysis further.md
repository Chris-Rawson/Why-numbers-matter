...
## Chi-square testa
A [chi-square test](link) can be used to help you figure out if the way something distributed has happened by chance.  This helps you to identify variables of interest.  
...
You might use a chi-square test to figure out if someone's gender impacts on their spending habits.
